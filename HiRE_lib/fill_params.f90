...
MODULE FILL_PARAMS
   ...
   CONTAINS
      ...
      SUBROUTINE FILL_HIRE_PARAMS()
         ...
         twwAA = 2.00 * SCORE_RNA(41)
         twwAC = 2.00 * SCORE_RNA(41)
         twwAU = 2.10 * SCORE_RNA(41)
         twwGG = 2.00 * SCORE_RNA(41)
         twwGC = 1.80 * SCORE_RNA(41)
         twwGU = 2.00 * SCORE_RNA(41)
         twwCC = 2.40 * SCORE_RNA(41)
         twwCU = 2.20 * SCORE_RNA(41)
         twwUU = 2.30 * SCORE_RNA(41)
