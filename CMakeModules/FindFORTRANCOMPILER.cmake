...
if(NOT COMPILER_FLAGS_WERE_SET)
   ...
   if(COMPILER_SWITCH MATCHES "pgi")
      ...
      set (CMAKE_Fortran_FLAGS_RELEASE "-O4 -Munroll -Mnoframe" CACHE TYPE STRING FORCE)
      set (CMAKE_Fortran_FLAGS_DEBUG "-g -gopt -Mbounds -Mchkfpstk -Mchkptr -Mchkstk -traceback" CACHE TYPE STRING FORCE)
      set (CMAKE_Fortran_FLAGS_DEBUG_SLOW "-g -gopt -Mbounds -Mchkfpstk -Mchkptr -Mchkstk -traceback" CACHE TYPE STRING FORCE)
      set (FORTRAN_FREEFORM_FLAG "-Mfree" CACHE TYPE STRING)
   elseif(COMPILER_SWITCH MATCHES "gfortran")
      set (CMAKE_Fortran_FLAGS "-ffixed-line-length-132 -ffree-line-length-0 -fallow-argument-mismatch" CACHE TYPE STRING FORCE)
...
#      set (CMAKE_Fortran_FLAGS_DEBUG "-g -fbounds-check -Wuninitialized -O -ftrapv -fimplicit-none -fno-automatic" CACHE TYPE STRING FORCE)
      set (CMAKE_Fortran_FLAGS_DEBUG "-g -fbounds-check -Wuninitialized -O -ftrapv -fimplicit-none" CACHE TYPE STRING FORCE)
      set (CMAKE_Fortran_FLAGS_DEBUG_SLOW "${CMAKE_Fortran_FLAGS_DEBUG}" CACHE TYPE STRING FORCE)
   ...
   elseif(COMPILER_SWITCH MATCHES "nag")
      ...
      set (CMAKE_Fortran_FLAGS_RELEASE "-O4 -mismatch_all" CACHE TYPE STRING FORCE)
      set (CMAKE_Fortran_FLAGS_DEBUG "-g -ieee=stop -u" CACHE TYPE STRING FORCE)
      set (CMAKE_Fortran_FLAGS_DEBUG_SLOW "-C=all -mtrace=all -gline -g -ieee=stop -u" CACHE TYPE STRING FORCE)
      set (FORTRAN_FREEFORM_FLAG "-free" CACHE TYPE STRING) # js850> is this ever used?
   elseif(COMPILER_SWITCH MATCHES "ifort")
      set (CMAKE_Fortran_FLAGS "-132 -assume byterecl -heap-arrays 10" CACHE TYPE STRING FORCE)
      set (CMAKE_Fortran_FLAGS_RELEASE "-O3" CACHE TYPE STRING FORCE)
# Warnings about temporary argument creation and edit descriptor widths are disabled with the final flags.
      set (CMAKE_Fortran_FLAGS_DEBUG "-traceback -debug all -check all,noarg_temp_created -diag-disable 8290,8291 -implicitnone" CACHE TYPE STRING FORCE)
      set (CMAKE_Fortran_FLAGS_DEBUG_SLOW "-traceback -debug all -check all,noarg_temp_created -warn unused -fp-stack-check -ftrapuv -implicitnone" CACHE TYPE STRING FORCE)
