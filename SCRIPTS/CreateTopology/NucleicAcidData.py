...
class Angle_NA:
    def __init__(self, name, atom1, atom2, atom3, force, ang):
        self.name = name
        self.atom1 = atom1
        self.atom2 = atom2
        self.atom3 = atom3
...
class Dihedral_NA:
    def __init__(self, name, atom1, atom2, atom3, atom4, force, dih, nterm):
        self.name = name
        self.atom1 = atom1
        self.atom2 = atom2
        self.atom3 = atom3
...
NA_angles = [	
        Angle_NA("RNA01", "R4", "R1", "A1",  70, 123.6),
		Angle_NA("RNA02", "R4", "R1", "U1",  70, 132.5),
		Angle_NA("RNA03", "R4", "R1", "G1",  70, 123.5),
		Angle_NA("RNA04", "R4", "R1", "C1",  70, 131.1),
		Angle_NA("RNA05", "R1", "A1", "A2", 120, 116.7),
		Angle_NA("RNA06", "R1", "G1", "G2", 120, 111.2),
		Angle_NA("RNA07",  "P",  "O",  "C",  70, 122.9),
		Angle_NA("RNA08",  "O",  "C", "R4",  70, 110.6),
		Angle_NA("RNA09",  "C", "R4",  "P",  70,  98.0),
		Angle_NA("RNA10", "R4",  "P",  "O",  50, 110.0),    
		Angle_NA("RNA11",  "C", "R4", "R1",  70, 135.5),
		Angle_NA("RNA12", "R1", "R4",  "P", 100,  98.0),
		Angle_NA("RNA13",  "D",  "D",  "D",  80, 180.0),
        Angle_NA("DNA01", "R4", "S1", "A1",  70, 130.0),
		Angle_NA("DNA02", "R4", "S1", "T1",  70, 142.0),
		Angle_NA("DNA03", "R4", "S1", "G1",  70, 131.0),
		Angle_NA("DNA04", "R4", "S1", "C1",  70, 146.0),
		Angle_NA("DNA05", "S1", "A1", "A2", 120, 116.0),
		Angle_NA("DNA06", "S1", "G1", "G2", 120, 111.2),
		Angle_NA("DNA07",  "P",  "O",  "C",  70, 120.0),
		Angle_NA("DNA08",  "O",  "C", "R4",  70, 110.6),
		Angle_NA("DNA09",  "C", "R4",  "P",  70, 110.0),
		Angle_NA("DNA10", "R4",  "P",  "O",  50, 105.0),    
		Angle_NA("DNA11",  "C", "R4", "S1",  70, 130.0),
		Angle_NA("DNA12", "S1", "R4",  "P", 100,  85.0),
		Angle_NA("DNA13",  "D",  "D",  "D",  80, 180.0)]

NA_dihs = [	
        Dihedral_NA("RNA01", "R4", "R1", "G1", "G2", 1.0,     -20, 1),
		Dihedral_NA("RNA02", "R4", "R1", "G1", "G2", 0.2,    -160, 1),
		Dihedral_NA("RNA03", "R4", "R1", "A1", "A2", 1.0,     -20, 1),
		Dihedral_NA("RNA04", "R4", "R1", "A1", "A2", 0.2,  -160.0, 1),    
		Dihedral_NA("RNA05", "R4", "A1", "A2", "R1", 1.0,  -165.0, 1),
		Dihedral_NA("RNA06", "R4", "G1", "G2", "R1", 1.0,  -165.0, 1),
		Dihedral_NA("RNA07",  "C", "R4", "R1", "A1", 1.0,  -150.0, 1),
		Dihedral_NA("RNA08",  "C", "R4", "R1", "A1", 0.2,   150.0, 1),
		Dihedral_NA("RNA09",  "C", "R4", "R1", "G1", 1.0,  -150.0, 1),
		Dihedral_NA("RNA10",  "C", "R4", "R1", "C1", 1.0,  -150.0, 1),
		Dihedral_NA("RNA11",  "C", "R4", "R1", "C1", 0.2,   150.0, 1),
		Dihedral_NA("RNA12",  "C", "R4", "R1", "U1", 1.0,  -150.0, 1),
		Dihedral_NA("RNA13",  "C", "R4", "R1", "U1", 0.2,   150.0, 1),
		Dihedral_NA("RNA14",  "P", "R4", "R1", "A1", 1.0,   100.0, 1),
		Dihedral_NA("RNA15",  "P", "R4", "R1", "G1", 1.0,   100.0, 1),
		Dihedral_NA("RNA16",  "P", "R4", "R1", "C1", 1.0,   100.0, 1),
		Dihedral_NA("RNA17",  "P", "R4", "R1", "U1", 1.0,   100.0, 1),
		Dihedral_NA("RNA18",  "C", "R4",  "P",  "O", 1.2,    20.0, 1),
		Dihedral_NA("RNA19", "R1", "R4",  "P",  "O", 1.2,   160.0, 1),
		Dihedral_NA("RNA20",  "O",  "C", "R4",  "P", 1.0,    90.0, 3),
		Dihedral_NA("RNA21",  "O",  "C", "R4", "R1", 1.0,   150.0, 1),
		Dihedral_NA("RNA22",  "P",  "O",  "C", "R4", 0.33,    0.0, 1),
		Dihedral_NA("RNA23",  "P",  "O",  "C", "R4", 0.125, 180.0, 2),
		Dihedral_NA("RNA24",  "P",  "O",  "C", "R4", 0.83,    0.0, 3),
		Dihedral_NA("RNA25", "R4",  "P",  "O",  "C", 1.00,    0.0, 2),
