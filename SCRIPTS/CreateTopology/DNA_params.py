...
DNA_bonds = [	Bond_DNA("R4",  "P",  30, 3.950),
		Bond_DNA("R4", "S1", 200, 2.344),
		Bond_DNA("S1", "G1", 200, 2.622),
		Bond_DNA("S1", "A1", 200, 2.633),
		Bond_DNA("S1", "T1", 200, 3.062),
		Bond_DNA("S1", "C1", 200, 3.004),
...
DNA_angles = [	Angle_DNA("R4", "S1", "A1",  70, 130.0),
		Angle_DNA("R4", "S1", "T1",  70, 142.0),
		Angle_DNA("R4", "S1", "G1",  70, 131.0),
		Angle_DNA("R4", "S1", "C1",  70, 146.0),
		Angle_DNA("S1", "A1", "A2", 120, 116.0),
		Angle_DNA("S1", "G1", "G2", 120, 111.2),
		Angle_DNA( "P",  "O",  "C",  70, 120.0),
		Angle_DNA( "O",  "C", "R4",  70, 110.6),
		Angle_DNA( "C", "R4",  "P",  70, 110.0),
		Angle_DNA("R4",  "P",  "O",  50, 105.0),    
		Angle_DNA( "C", "R4", "S1",  70, 130.0),
		Angle_DNA("S1", "R4",  "P", 100,  85.0),
		Angle_DNA( "D",  "D",  "D",  80, 180.0)]
 
DNA_dihs = [	Dihedral_DNA("R4", "S1", "G1", "G2", 1.0,  -120.0, 2),
		Dihedral_DNA("R4", "S1", "A1", "A2", 1.0,  -120.0, 2),
		Dihedral_DNA("R4", "S1", "A1", "A2", 0.2,   160.0, 1),    
		Dihedral_DNA("R4", "A1", "A2", "S1", 1.0,   165.0, 1),
		Dihedral_DNA( "C", "R4", "S1", "A1", 1.0,   150.0, 1),
		Dihedral_DNA( "C", "R4", "S1", "G1", 1.0,   150.0, 1),
		Dihedral_DNA( "C", "R4", "S1", "C1", 1.0,   150.0, 1),
		Dihedral_DNA( "C", "R4", "S1", "U1", 1.0,   150.0, 1),
		Dihedral_DNA( "P", "R4", "S1", "A1", 1.0,    30.0, 1),
		Dihedral_DNA( "P", "R4", "S1", "G1", 1.0,    30.0, 1),
		Dihedral_DNA( "P", "R4", "S1", "C1", 1.0,    30.0, 1),
		Dihedral_DNA( "P", "R4", "S1", "U1", 1.0,    30.0, 1),
		Dihedral_DNA( "C", "R4",  "P",  "O", 1.2,    5.0, 1),
		Dihedral_DNA("S1", "R4",  "P",  "O", 1.2,   160.0, 1),
		Dihedral_DNA( "O",  "C", "R4",  "P", 1.0,    90.0, 3),
		Dihedral_DNA( "O",  "C", "R4", "S1", 1.0,   150.0, 1),
