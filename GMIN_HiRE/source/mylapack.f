...
C     TEST IF TWO REAL(KIND = REAL64) ARRAYS ARE IDENTICAL.
C     THE ARRAYS ARE M BY N.
C     THIS IS A TEST SUBPROGRAM FOR THE LEVEL TWO BLAS.
C     REVISED 860623
C     REVISED YYMMDD
C     AUTH=R. J. HANSON, SANDIA NATIONAL LABS.
      REAL(KIND = REAL64) DI(LDI,*),DJ(LDI,*)
      DO 20 I = 1,M 
         DO 10 J = 1,N
...
*
*  AB      (input/output) REAL(KIND = REAL64) array, dimension (LDAB,N)
...
*
*     .. Parameters ..
      REAL(KIND = REAL64)   ONE, ZERO
      PARAMETER          ( ONE = 1.0D+0, ZERO = 0.0D+0 )
*     ..
*     .. Local Scalars ..
      LOGICAL            UPPER
      INTEGER            J, KLD, KN
      REAL(KIND = REAL64)   AJJ
*     ..
*     .. External Functions ..
      LOGICAL            LSAME
      EXTERNAL           LSAME
...
*     ..
*     .. Local Arrays ..
      REAL(KIND = REAL64)   WORK( LDWORK, NBMAX )
*     ..
*     .. External Functions ..
      LOGICAL            LSAME
      INTEGER            ILAENV
...
*           Unchanged on exit.
*
*  A      - REAL(KIND = REAL64) array of DIMENSION ( LDA, n ).
...
*           Unchanged on exit.
*
*  X      - REAL(KIND = REAL64) array of dimension at least
*           ( 1 + ( n - 1 )*abs( INCX ) ).
*           Before entry, the incremented array X must contain the n
*           element right-hand side vector b. On exit, X is overwritten
*           with the solution vector x.
...
*     ..
*     .. Array Arguments ..
      REAL(KIND = REAL64)   AB( LDAB, * ), B( LDB, * )
*     ..
*
*  Purpose
*  =======
...
*
*  AB      (input) REAL(KIND = REAL64) array, dimension (LDAB,N)
...
*          The leading dimension of the array AB.  LDAB >= KD+1.
*
*  B       (input/output) REAL(KIND = REAL64) array, dimension (LDB,NRHS)
