...
if test "x${FC}" == "xnag"; then :
  echo "          subroutine flush(UNIT) ! flushes the output buffer of logical unit UNIT which must be"
  echo "          use f90_unix, NAGflush => flush ! connected for formatted sequential output"
  echo "               implicit none"
  ...
  echo "          subroutine flush(UNIT) ! flushes the output buffer of logical unit UNIT which must be"
  echo "               implicit none ! connected for formatted sequential output"
  echo "               integer,intent(in) :: UNIT"
