...
*> \verbatim
*>
*> DROUNDUP_LWORK deals with a subtle bug with returning LWORK as a
*Float.
*> This routine guarantees it is rounded up instead of down by
*> multiplying LWORK by 1+eps when it is necessary, where eps is the
...
*>
*> \verbatim
*>  This routine was inspired in the method `magma_zmake_lwork` from
*MAGMA.
*>  \see
*https://bitbucket.org/icl/magma/src/master/control/magma_zauxiliary.cpp
*> \endverbatim
*
*  =====================================================================
      DOUBLE PRECISION FUNCTION droundup_lwork( LWORK )
